...
# FIX: Import the dedicated single-pair predictor, not the dataset evaluation loop
from infer import predict_single_pair
...
def visualize_dataset(manifest_csv: str, method: str = "ncc", num_samples: int = 5, save_dir: str = "visualizations"):
    ...
    for idx in sample_indices:
        ...
        # FIX: Pass the raw images directly to the single-pair predictor helper
        if method == "loftr":
            pred_x, pred_y = predict_single_pair(ref_img, search_img, matcher, device)
